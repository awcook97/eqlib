...
// Reordered for April 15, 2026 live binary via MultiTargetFunc + assembly verification
...
/*0x0490*/ unsigned int             HibernatingCount;
/*0x0494*/ bool                     Mercenary;
/*0x0498*/ int                      Unknown1;
/*0x049c*/ bool                     bAlwaysShowAura;
/*0x049d*/ EqItemGuid               realEstateItemGuid;
/*0x04af*/ char                     DraggingPlayer[0x40];
/*0x04f0*/ int                      SecondaryTintIndex;
/*0x04f4*/ LaunchSpellData          CastingData;
/*0x0538*/ unsigned int**           ppUDP;
/*0x0540*/ int64_t                  HPCurrent;
/*0x0548*/ bool                     bBuffTimersOnHold;
/*0x0549*/ char                     LoginRelated[0x20];
/*0x056c*/ int                      Buyer;
/*0x0570*/ int                      ManaMax;
/*0x0574*/ unsigned int             LoginSerial;
/*0x0578*/ uint8_t                  StandState;
/*0x0579*/ uint8_t                  CharClass;
/*0x057c*/ unsigned int             Zone;
/*0x0580*/ int                      PetID;
/*0x0584*/ bool                     bSummoned;
/*0x0588*/ int                      IsAttacking;
/*0x058c*/ unsigned int             RespawnTimer;
/*0x0590*/ CharacterZoneClient*     pCharacter;
/*0x0598*/ int                      DoSpecialMelee;
/*0x059c*/ bool                     bAttackRelated;
/*0x059d*/ bool                     LFG;
/*0x05a0*/ unsigned int             SpellCooldownETA;
/*0x05a4*/ uint8_t                  FD;
/*0x05a8*/ unsigned int             MasterID;
/*0x05ac*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x05b4*/ unsigned int             LastRefresh;
/*0x05b8*/ unsigned int             LastTrapDamageTime;
/*0x05bc*/ bool                     bTempPet;
/*0x05bd*/ bool                     PvPFlag;
/*0x05c0*/ int                      AltAttack;
/*0x05c4*/ unsigned int             LastPrimaryUseTime;
/*0x05c8*/ int                      RealEstateID;
/*0x05cc*/ unsigned int             NextSwim;
/*0x05d0*/ unsigned int             SpellGemETA[15];
/*0x060c*/ float                    ViewHeight;
/*0x0610*/ void*                    pTouchingSwitch;
/*0x0618*/ unsigned int             TimeStamp;
/*0x061c*/ bool                     bOfflineMode;
/*0x061d*/ uint8_t                  LastAttack;
/*0x061e*/ uint8_t                  IntimidateCount;
/*0x061f*/ uint8_t                  IsPassenger;
/*0x0620*/ bool                     Sneak;
/*0x0621*/ bool                     bBetaBuffed;
/*0x0622*/ bool                     bSwitchMoved;
/*0x0623*/ uint8_t                  FindBits;
/*0x0624*/ uint8_t                  Original;
/*0x0628*/ unsigned int             CorpseDragCount;
/*0x0630*/ void*                    pRaceGenderInfo;
/*0x0638*/ unsigned int             Meditating;
...
/*0x0fc0*/ int64_t            Unknown0x0FC0;              // Apr 2026: new pointer, pushed mActorClient +8
...
/*0x2010*/ HashList<uint64_t, 5> BardMelodyQueue; // /queuemelody related - definitely not a HashList // 2010
/*0x2058*/ PlayerPhysicsClient mPlayerPhysicsClient;
/*0x2090*/ int               SpawnStatus[6];
/*0x20a8*/ int               BannerIndex0;                 // guild banners
/*0x20ac*/ int               BannerIndex1;
/*0x20b0*/ ARGBCOLOR         BannerTint0;
/*0x20b4*/ ARGBCOLOR         BannerTint1;
/*0x20b8*/ int               MountAnimationRelated;
/*0x20bc*/ bool              bGuildShowAnim;               // or sprite? need to check
/*0x20bd*/ bool              bWaitingForPort;
/*0x20c0*/
